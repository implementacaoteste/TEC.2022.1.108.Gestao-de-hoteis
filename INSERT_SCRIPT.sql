...
-- RESERVA  --12º
INSERT INTO RESERVA VALUES('2023-05-30','2023-06-06',630.00,1,2,2,1,'Carro preto placa: JK59L3',250.00,null,null,'','',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-05-19','2023-05-23',500.00,1,2,2,1,'Carro branco placa: L05LPS',250.00,'2023-05-19','2023-05-23','Nada','Nada',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-05-22','2023-05-31',500.00,1,2,2,1,'Carro azul placa: 203KSO',250.00,'2023-05-22','2023-05-31','Nada','Nada',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-05-22','2023-05-31',500.00,1,2,2,1,'Carro vermelho placa: OJE493K',250.00,'2023-05-22','2023-05-31','Nada','Nada',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-06-01','2023-06-03',500.00,2,1,1,1,'Carro prata placa: KLJ829',250.00,'2023-06-01','2023-06-03','Nada','Nada',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-05-19','2023-05-22',500.00,1,3,3,1,'Carro prata placa: PS5LKO',250.00,'2023-05-19','2023-05-22','Nada','Nada',GETDATE(),0)
INSERT INTO RESERVA VALUES('2023-05-18','2023-05-20',500.00,1,2,2,1,'Carro preto placa: JK59L3',250.00,'2023-05-18','2023-05-20','Nada','Nada',GETDATE(),0)
...
SELECT SUM(VALOR) FROM CONTAS_A_RECEBER WHERE RECEBIDO = 0
SELECT SUM(VALOR) FROM CONTAS_A_PAGAR WHERE PAGAR = 0

SELECT SUM(VALOR) FROM CONTAS_A_RECEBER WHERE RECEBIDO = 1
SELECT SUM(VALOR) FROM CONTAS_A_PAGAR WHERE PAGAR = 1
...
UPDATE QUARTO SET ID_STATUS = 3 WHERE ID = 1
